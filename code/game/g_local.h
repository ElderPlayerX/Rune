...
// g_misc.c
//
void TeleportPlayer( gentity_t *player, vec3_t origin, vec3_t angles, qboolean dropFlags, qboolean pushForward );
#ifdef MISSIONPACK
...
int Rune_ActionMovie_Think(gentity_t *ent,int weapon);
...
void Rune_Athletics_Think(gentity_t *ent);
...
// RQ3: Begin CVARs
extern	vmCvar_t	g_RuneNumber;
extern	vmCvar_t	g_RuneModels;
extern	vmCvar_t	g_RuneDropTime;			
extern	vmCvar_t	g_RuneDeathDrop;
extern	vmCvar_t	g_RuneFlightDuration;
extern	vmCvar_t	g_Discharge;
