...
//	{ &cg_pmove_fixed, "cg_pmove_fixed", "0", CVAR_USERINFO | CVAR_ARCHIVE }
	...
	// RQ3: Client CVAR data
	{ &cg_Rune_DrawDesc, "cg_Rune_DrawDesc", "1", CVAR_USERINFO  }
...
static void CG_RegisterGraphics( void ) {
	...
	// RQ3:  Rune Shaders
	cgs.media.berserkShader = trap_R_RegisterShader( "berserkShader" );
	cgs.media.berserkWeaponShader = trap_R_RegisterShader( "berserkShaderWeapon" );
	cgs.media.frozenShader = trap_R_RegisterShader("frozen" );
	cgs.media.reflectionShader = trap_R_RegisterShader("reflectionShader" );
	cgs.media.phaseShader = trap_R_RegisterShader("runes/phase" );
