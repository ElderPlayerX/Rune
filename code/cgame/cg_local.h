...
typedef struct {
	...
	// RQ3:  Client-side effects
	int				shroomTime;			//  shroom mode 
	int				twirlyTime;			//  twirly head 
	int				drunkTime;			//  drunk walk
	int				flashTime;			//  flash
...
// RQ3: Client CVARs
extern	vmCvar_t	cg_Rune_DrawDesc;
